...
class CanTool:
        def __init__(self):
                ...
                self.can_bus = Bus(interface='socketcan', channel='can0', fd=True, can_filters=ota_filters)
        ...
        def send_can_data(self, is_fd: bool, bitrate_switch: bool, can_id: int, can_data: List[int]):
                can_message = Message(is_fd=is_fd, bitrate_switch=bitrate_switch, arbitration_id=can_id, data=can_data, is_extended_id=False)
